...
Date | Time | Workshop | Topics
---|---|---|---------
9/14 | TBD | Hacking it in the Tidyverse | Tricks from **lubridate**, `group_by`, `spread/gather`, `rename_all`, etc. plus the basics of writing functions
