---
title: "How Work in R Gets Shared3"
...
with a table of contents that includes all the first and second-level headers. The 
interesting thing is that R Markdown can incorporate other languges such as Python: 
